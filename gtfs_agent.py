...
SUBURB_COMMUTE = {
    ...
    "Bondi":           (5, "bus",    25),
    "Camperdown":      (7, "bus",    15),
    "Collaroy Plateau":(3, "bus",    50),
    "Cremorne":        (7, "bus",    20),
    "Cromer":          (3, "bus",    50),
    "Drummoyne":       (6, "bus",    20),
    "Dundas":          (6, "train",  35),
    "East Killara":    (7, "train",  40),
    "Gordon":          (8, "train",  35),
    "Killara":         (8, "train",  38),
    "Kirribilli":      (8, "bus",    15),
    "Lindfield":       (8, "train",  35),
    "Manly Vale":      (5, "bus",    40),
    "Mortlake":        (5, "bus",    25),
    "Narraweena":      (4, "bus",    45),
    "North Sydney":    (9, "train",  10),
    "Pymble":          (7, "train",  42),
    "Queenscliff":     (5, "bus",    45),
    "South Granville": (6, "train",  38),
    "Turramurra":      (7, "train",  45),
    "Woollahra":       (6, "bus",    20),
}
